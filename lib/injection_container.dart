...
final ImgListUseCaseContract imgListUseCaseContract = ImgListUseCaseContract();
...
void init() {
  sl.registerFactory(() => ImgBloc(
        ...
        searchImgUseCase: sl(),
        imgListUseCaseContract: imgListUseCaseContract,
      ));
  ...
  sl.registerLazySingleton(
    () => ImgDataSourceImpl(
        httpClient: sl(), imgListUseCaseContract: imgListUseCaseContract),
  );
