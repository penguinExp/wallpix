...
class _$ServerFailure extends ServerFailure with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties..add(DiagnosticsProperty('type', 'FailureEntity.serverFailure'));
  }
...
class _$DataParsingFailure extends DataParsingFailure
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'FailureEntity.dataParsingFailure'));
  }
...
class _$NoConnectionFailure extends NoConnectionFailure
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'FailureEntity.noConnectionFailure'));
  }
